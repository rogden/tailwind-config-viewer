...
### Fixed
- [#92](https://github.com/rogden/tailwind-config-viewer/issues/92#issuecomment-2178159103) Resolves issue related URL scheme on Windows for export command

## [2.0.3] 2024-06-16

### Fixed
- [#92](https://github.com/rogden/tailwind-config-viewer/issues/92#issuecomment-2028626622) Resolves issue related URL scheme on Windows

## [2.0.2] 2024-04-28

### Fixed
- [#93](https://github.com/rogden/tailwind-config-viewer/issues/93) Removed console.log (Thanks @ineshbose!)
