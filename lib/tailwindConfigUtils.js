...
const resolveConfig = config => {
  return transformConfig(resolveTailwindConfig(config), config)
}
...
const transformConfig = (config, unResolvedConfig) => {
  ...
  removeDisabledCorePlugins(config, unResolvedConfig)
...
const removeDisabledCorePlugins = (config, unResolvedConfig) => {
  Object.keys(unResolvedConfig.corePlugins).forEach(key => {
    if (unResolvedConfig.corePlugins[key] === false) {
